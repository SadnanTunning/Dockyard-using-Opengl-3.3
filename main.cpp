...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "CSE 426: Docyard Project Sadnan 20101106", NULL, NULL);
    if (window == NULL)
    {
    ...
    // ------------------------------------------------------------------
//vertex data for rendering a cube
    float cube_vertices[] = {
        // positions      // normals
    ...
    //Configuring Vertex Attributes for Main Cube
    // position attribute
...
//
    ...
    string diffuseMapPath = "water1.png";
    string specularMapPath = "water1.png";
